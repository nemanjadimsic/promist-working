...
/* harmony import */ var ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ng-multiselect-dropdown */ "./node_modules/ng-multiselect-dropdown/fesm2015/ng-multiselect-dropdown.js");
/* harmony import */ var angular2_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! angular2-multiselect-dropdown */ "./node_modules/angular2-multiselect-dropdown/fesm2015/angular2-multiselect-dropdown.js");
...
const authUrl = "https://promist-logistics-app.herokuapp.com/api/auth/";
...
let MagacinService = class MagacinService {
    constructor(http) {
        this.http = http;
    }
    getAll() {
...
let DjubrivoComponent = class DjubrivoComponent {
    constructor(mservice, router) {
    ...
    addButton() {
        ...
        this.msg = false;
        this.mservice.addDjubrivo(this.form_naziv.value).subscribe(data => {
            alert("Dodato novo djubrivo");
            this.router.navigate(['početna']);
        });
    }
};
DjubrivoComponent.ctorParameters = () => [
...
let HomepageComponent = class HomepageComponent {
    ...
    ngOnInit() {
        ...
        this.mservice.getAll().subscribe(data => {
            this.magacini = data;
            this.mservice.getAllRoba().subscribe(robs => {
                this.roba = robs;
                this.mservice.getAllLots().subscribe(lt => {
                    this.lots = lt;
                });
            });
        });
    ...
    testButton() {
        ...
        this.mservice.promena(obj2send).subscribe(data => {
            console.log(data);
            if (data != null) {
...
let IzvestajdetaljComponent = class IzvestajdetaljComponent {
    constructor(mservice, router) {
        this.mservice = mservice;
        this.router = router;
    ...
    getNaDan() {
        ...
        this.mservice.izvestajDetaljno(obj2send).subscribe(data => {
            console.log(data);
            if (data == null) {
                this.message = true;
                return;
            ...
            this.message = false;
            this.value = data;
            this.value = this.value.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
        });
    }
};
IzvestajdetaljComponent.ctorParameters = () => [
    { type: src_app_services_magacin_service__WEBPACK_IMPORTED_MODULE_3__["MagacinService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
];
...
let IzvestajreproComponent = class IzvestajreproComponent {
    constructor(mservice, router) {
        this.mservice = mservice;
        this.router = router;
    ...
    addNapomena(id) {
        ...
        this.mservice.addNapomenaRepro(obj2send).subscribe(data => {
    ...
    showTa() {
        ...
        this.mservice.getAllPromenaRepro(this.obj2filter).subscribe(data => {
            console.log("promene");
            this.obj4table = data;
            this.obj4table = underscore__WEBPACK_IMPORTED_MODULE_5__["sortBy"](this.obj4table, 'datum').reverse();
            console.log(this.obj4table);
            if (this.obj4table.length == 0) {
                this.showTable = false;
                this.nema = true;
            }
            else {
            ...
            var summ = 0;
            this.obj4table.forEach(element => {
            ...
            this.obj4table.push(sumElement);
        });
        this.headerobj = {
    ...
    downloadAsPdf() {
        let doc = new jspdf__WEBPACK_IMPORTED_MODULE_6__();
...
IzvestajreproComponent.ctorParameters = () => [
...
let LagerlistaComponent = class LagerlistaComponent {
    constructor(router, mservice) {
        this.router = router;
        this.mservice = mservice;
    ...
    ngOnInit() {
        ...
        this.mservice.getAll().subscribe(data => {
            this.magacini = data;
            this.magacini.forEach(ele => {
                this.dropdownList.push({ id: ele.item_id, itemName: ele.item_text });
            });
            if (this.dropdownList.length == this.magacini.length) {
                this.showDropdown = true;
                this.dropdownList.push({ id: 999, itemName: 'Ukupno svi' });
            }
            this.mservice.getAllRoba().subscribe(robs => {
                this.roba = robs;
                this.mservice.getAllLots().subscribe(lt => {
    ...
    getLager() {
        ...
        if (this.selectedItems[0].id == 999) {
            console.log('SVI');
            this.mservice.getAllLagers().subscribe(datz => {
                this.lagers = datz;
                this.mag = "Ukupno svi magacini";
        ...
        */
                ...
                if (npkFoksan != null) {
                    for (var key in npkFoksan.pakovanjaKolicine) {
                        ...
                        this.sum[12] += npkFoksan.pakovanjaKolicine[key];
                        this.npkFoksan.push(pp);
                    }
                    this.toShow[12] = (this.sum[12]).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                }
                var npk16168 = this.lagers[13];
                if (npk16168 != null) {
                    for (var key in npk16168.pakovanjaKolicine) {
                        ...
                        this.sum[13] += npk16168.pakovanjaKolicine[key];
                        this.npk16168.push(pp);
                    }
                    this.toShow[13] = (this.sum[12]).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                }
                for (let b = 0; b < this.sum.length; b++) {
                    this.sum[b] = +this.sum[b].toFixed(2);
                    this.tableShow[b] = (this.sum[b]).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
            ...
            this.mservice.getLager(this.selectedItems[0].id).subscribe(data => {
                this.lagers = data;
                console.log(data);
                var dvapet = this.lagers[0];
                this.mag = dvapet.magacin;
                ...
                this.toShow[13] = (this.sum[13]).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                for (let b = 0; b < this.sum.length; b++) {
                    this.sum[b] = +this.sum[b].toFixed(2);
                    this.tableShow[b] = (this.sum[b]).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                }
            ...
            var niz2send = [];
            this.selectedItems.forEach(nnn => {
                if (nnn.id != 999) {
                    niz2send.push({ item_id: nnn.id, item_text: nnn.itemName });
                }
            });
            this.mservice.getLagerSviDetaljno(niz2send).subscribe(data => {
                //this.lagers = data;
                this.detaljnoSvi = true;
                this.svimagacinisvimarlepi = [];
                this.showTable = true;
                this.showTable = false;
                this.magacinNSP6 = [];
                ...
                this.magacinNSUS = [];
                this.magacinPAUS = [];
                for (let marlep of data) {
                    if (marlep.magacin == "Novi Sad, Privrednikova 6") {
                        this.magacinNSP6.push(marlep);
                    }
                    if (marlep.magacin == "Novi Sad, Ribarska 3") {
                        this.magacinNSR3.push(marlep);
                    }
                    if (marlep.magacin == "Vrbas, Kulski put 2") {
                        this.magacinVRK2.push(marlep);
                    }
                    if (marlep.magacin == "Pančevo, Prvomajska 10") {
                        this.magacinPAP10.push(marlep);
                    }
                    if (marlep.magacin == "Sremski Karlovci, Donji Matej bb") {
                        this.magacinSKDMT.push(marlep);
                    }
                    if (marlep.magacin == "Novi Sad, Uslužni magacin") {
                        this.magacinNSUS.push(marlep);
                    }
                    if (marlep.magacin == "Pančevo, Uslužni magacin") {
                        this.magacinPAUS.push(marlep);
                    }
                }
                if (this.magacinSKDMT.length != 0) {
                    this.svimagacinisvimarlepi.push(this.magacinSKDMT);
                }
                if (this.magacinNSUS.length != 0) {
                    this.svimagacinisvimarlepi.push(this.magacinNSUS);
                }
                if (this.magacinNSR3.length != 0) {
                    this.svimagacinisvimarlepi.push(this.magacinNSR3);
                }
                if (this.magacinPAP10.length != 0) {
                    this.svimagacinisvimarlepi.push(this.magacinPAP10);
                }
                if (this.magacinVRK2.length != 0) {
                    this.svimagacinisvimarlepi.push(this.magacinVRK2);
                }
                if (this.magacinPAUS.length != 0) {
                    this.svimagacinisvimarlepi.push(this.magacinPAUS);
                }
                if (this.magacinNSP6.length != 0) {
                    this.svimagacinisvimarlepi.push(this.magacinNSP6);
                }
    ...
    printLager() {
        let doc = new jspdf__WEBPACK_IMPORTED_MODULE_2__({ orientation: 'landscape', format: 'tabloid' });
        ...
        if (this.detaljnoSvi) {
            ...
            for (let magk of this.svimagacinisvimarlepi) {
                var sumica = 0;
                for (let i = 0; i < magk.length; i++) {
    ...
    pakovanjeChange(event) {
        if (this.djubrivo_form.value == "" || this.lot_form.value == "" || this.pakovanje_form.value == null || this.pakovanje_form.value == "") {
            ...
            this.mservice.getstanje({
                ...
                this.trenutna = data;
                this.trenutna.novostanje = (this.trenutna.novostanje).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
            });
        }
    }
};
LagerlistaComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
...
let LagerreproComponent = class LagerreproComponent {
    constructor(router, mservice) {
        this.router = router;
        this.mservice = mservice;
        this.crevas = [];
    ...
    getLager() {
        ...
        this.nazividzakova = [];
        this.stanjapaleta = [];
        this.mservice.getAllRoba().subscribe(dataa => {
            this.robs = dataa;
            this.robs = underscore__WEBPACK_IMPORTED_MODULE_5__["sortBy"](this.robs, 'naziv');
        });
        this.mservice.getLagerRepro(this.magacin_form.value).subscribe(data => {
            this.bb = data;
            console.table(this.bb);
            var hash0 = this.bb[0];
            var hash1 = this.bb[1];
            console.log(hash1);
            //if(bb[0].crevo == "") {
            ...
            for (let key in hh) {
                ...
                if (key == '25/1' || key == '50/1' || key == '500/1' ||
                    ...
                    this.nazividzakova.push(key);
                    this.stanjadzakova.push(hh[key]);
                }
                else if (key == '120*100' || key == '115*95') {
                    this.nazivipaleta.push(key);
                    this.stanjapaleta.push(hh[key]);
                }
                else {
                    this.s = key;
                    this.ss = hh[key];
            ...
            for (let key in c1) {
                this.customcols.push(key);
                console.log('a' + key + ': ' + c1[key]);
                this.vrednostiza100.push(c1[key]);
                this.show100.push((c1[key]).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,'));
            }
            var hash2 = this.bb[2];
            var c2 = hash2.robeStanja;
            for (let key in c2) {
                console.log(key + ': ' + c2[key]);
                this.vrednostiza120.push(c2[key]);
                this.show120.push((c2[key]).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,'));
            }
        });
    }
    clearForms() {
    ...
    azuriranje() {
        ...
        if (this.localizbor == 1) {
            ...
            this.mservice.azuriranjecrevo(obj2update).subscribe(data => {
                alert("Updated");
            ...
            obj2update.novostanje = this.novakolicina.value;
            this.mservice.azuriranjepalete(obj2update).subscribe(data => {
                alert("Updated");
                obj2update = new Object();
                window.location.reload();
            });
...
LagerreproComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: src_app_services_magacin_service__WEBPACK_IMPORTED_MODULE_3__["MagacinService"] }
];
...
let LagertabelaComponent = class LagertabelaComponent {
    constructor() {
        this.pedeset = [];
        this.kcl = [];
        this.urea = [];
...
let LoginComponent = class LoginComponent {
    constructor(aservice, authService, tokenStorage, router) {
    ...
    loginBtn() {
        ...
        this.aservice.attemptAuth(loginForm).subscribe(data => {
            console.log(data);
            this.jwtauth = data;
...
let NavbarComponent = class NavbarComponent {
    constructor(router, aservice, tokenS) {
        this.router = router;
        this.aservice = aservice;
        this.tokenS = tokenS;
    }
    ngOnInit() {
        this.aservice.getLogged().subscribe(data => {
            if (data == null) {
                this.router.navigate(['/prijava']);
                return;
            }
...
let NewreproComponent = class NewreproComponent {
    constructor(router, mservice) {
        this.router = router;
        this.mservice = mservice;
        this.magacin_form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("");
    ...
    ngOnInit() {
        ...
        this.mservice.getAll().subscribe(data => {
            ...
            this.mservice.getAllRoba().subscribe(robs => {
                this.roba = robs;
                this.mservice.getAllMaterijali().subscribe(mats => {
                    this.materijali = mats;
                });
            });
        });
        console.clear();
    ...
    unesiRepro() {
        ...
        this.mservice.unesiRepro(obj2send).subscribe(data => {
            alert("Uspesno unet repro materijal");
        });
    }
};
NewreproComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: src_app_services_magacin_service__WEBPACK_IMPORTED_MODULE_4__["MagacinService"] }
];
...
let PakovanjeComponent = class PakovanjeComponent {
    constructor(router, mservice) {
        this.router = router;
        this.mservice = mservice;
    ...
    ngOnInit() {
        ...
        this.mservice.getAll().subscribe(data => {
            ...
            this.mservice.getAllRoba().subscribe(robs => {
                this.roba = robs;
                this.mservice.getAllLots().subscribe(lott => {
                    this.lots = lott;
                });
            });
        });
    ...
    zapakuj() {
        ...
        this.mservice.pakuj(boj2send).subscribe(dax => {
            console.log(dax);
            if (dax == null) {
...
PakovanjeComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: src_app_services_magacin_service__WEBPACK_IMPORTED_MODULE_3__["MagacinService"] }
];
...
let ParseComponent = class ParseComponent {
    constructor(mservice, router) {
        this.mservice = mservice;
        this.router = router;
        this.err = false;
    ...
    uploadFileToActivity() {
        this.mservice.postFile(this.fileToUpload).subscribe(data => {
            this.obj4table = data;
            console.log(this.obj4table);
            this.parsed = true;
            if (this.obj4table.length == 0) {
...
let ReportComponent = class ReportComponent {
    ...
    filterTable() {
        ...
        this.obj4table = [];
        this.mservice.getPoDatumu(this.obj2filter).subscribe(data => {
            this.obj4table = data;
            var summ = 0;
            if (this.podsmer_form.value == "") {
                if (this.smer_form.value == "ulaz") {
                    this.obj4table = underscore__WEBPACK_IMPORTED_MODULE_7__["filter"](this.obj4table, function (itm) {
            ...
            else if (this.podsmer_form.value == "dobavljac") {
                if (this.smer_form.value == "ulaz") {
                    this.obj4table = underscore__WEBPACK_IMPORTED_MODULE_7__["filter"](this.obj4table, function (itm) {
            ...
            else if (this.podsmer_form.value == "interno") {
                if (this.smer_form.value == "ulaz") {
                    this.obj4table = underscore__WEBPACK_IMPORTED_MODULE_7__["filter"](this.obj4table, function (itm) {
    ...
    addNapomena(id) {
        ...
        this.mservice.addNapomena(obj2send).subscribe(data => {
            alert("Dodata napomena");
            id.hasNapomena = true;
            id.napomena = data.napomena;
        });
    ...
    showTa() {
        ...
        this.mservice.getAllPromena(this.obj2filter).subscribe(data => {
            console.log("promene");
            this.obj4table = data;
            this.obj4table = underscore__WEBPACK_IMPORTED_MODULE_7__["sortBy"](this.obj4table, 'datum').reverse();
            if (this.podsmer_form.value == "") {
    ...
    downloadAsPdf() {
        let doc = new jspdf__WEBPACK_IMPORTED_MODULE_2__();
        doc.autoTable({ html: '#tableid' });
        doc.save(`Izveštaj-${this.obj4table[0].magacinNaziv}-${this.obj4table[0].robaNaziv}-${new Date().toLocaleDateString()}.pdf`);
        console.clear();
        /*
